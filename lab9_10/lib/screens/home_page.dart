...
import 'package:lab4_5_widgets/bloc_provider.dart';
    ...
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder<int>(
          stream: StateBloc().indexStream,
          initialData: StateBloc().selectedIndex,
        ...
        bottomNavigationBar: Consumer<GlobalAppState>(
          builder: (context, globalAppState, child) {
            return NavigationBar(
              ...
              selectedIndex:
                  useBloc
                      ? StateBloc().selectedIndex
                      : globalAppState.selectedIndex,
              onDestinationSelected: (index) {
                if (useBloc) {
                  StateBloc().setSelectedIndex(index);
                } else {
                  globalAppState.setSelectedIndex(index);
                }
              },
            );
          },
